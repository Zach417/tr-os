var desktop = {
  ...
  setup: function (id) {
    this.id = id;
    this.imageBackground = loadImage('/slate-background.jpg');
  },
  ...
  drawInfoScreen: function () {
    ...
    textAlign(LEFT, TOP);
    textSize(36);
    text("3:05 PM", this.menuMargin, this.menuY + this.menuMargin);
    textSize(24);
    text("Saturday Jan 18", this.menuMargin, this.menuY + this.menuMargin + 40);
  },
